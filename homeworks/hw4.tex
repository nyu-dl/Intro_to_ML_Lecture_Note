...
Suppose that we are fitting an Adaptive RBFN with the formulation in Problem 3 on a toy dataset whose positive and negative samples are generated from two Gaussian distributions with very different variances:
...
Would the Adaptive RBFN work?  If so, how would the parameters (i.e. bases, weights, and biases) look like?  If not, how can we improve it?  \emph{You don't have to answer with math equations; plain English is fine.}
