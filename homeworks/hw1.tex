...
\paragraph{2.} We use the following distance function for perceptron in the
lecture:
\begin{align*}
    ...
    \tilde{\vx}\right).
\end{align*}
This distance function has a problem of a trivial solution. What does it mean by
this? What is the trivial solution?
