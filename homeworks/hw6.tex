...
\begin{itemize}
    \item[PCA]
        \url{https://github.com/nyu-dl/Intro_to_ML_Lecture_Note/blob/master/homeworks/hw5_pca.ipynb}
    \item[NMF]
        \url{https://github.com/nyu-dl/Intro_to_ML_Lecture_Note/blob/master/homeworks/hw5_nmf.ipynb}
\end{itemize}
