...
\paragraph{3.} (Programming Assignment)
Complete the implementation of PCA and NMF using Python
...
\begin{itemize}
    \item[PCA]
        \url{https://github.com/nyu-dl/Intro_to_ML_Lecture_Note/blob/master/homeworks/hw6_pca.ipynb}
    \item[NMF]
        \url{https://github.com/nyu-dl/Intro_to_ML_Lecture_Note/blob/master/homeworks/hw6_nmf.ipynb}
\end{itemize}
