...
\section{Gaussian process regression$^\star$}
...
\paragraph{Probabilistic principal component analysis}

\todo{!!!}

\paragraph{Gaussian process latent variable models}

\todo{!!!}

\paragraph{Matrix factorization with missing values}
