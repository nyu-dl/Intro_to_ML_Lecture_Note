...
Two question naturally arise here. First, why don't we estimate the
...
\begin{align*}
    \hat{C} = \argmin_C J_{\text{svm}}?
\end{align*}
Second, why do we need to omit this regularization term when selecting among
trained support vector machines each belonging to a different hypothesis set?
...
\paragraph{Example} In Fig.~\ref{fig:weight_decay}, we plot how the training and
validation costs change with respect to the regularization coefficient $C$ (or
equivalently $\log C$). 
