...
It is surprising to realize that this rule for logistic regression is identical
to the perceptron rule in Eq.~\eqref{eq:perceptron_rule0}.
...
\subsection{Regularization and Complexity}
