...
\begin{align*}
    s(\vx; \vw) = 0.
\end{align*}
When the score function is defined as a linear function of the input vector
...
Let us think of what it means for either the perceptron or logistic regression
to be {\it perfect}. 
