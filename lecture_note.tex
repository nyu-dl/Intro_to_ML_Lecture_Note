...
\abstract{
    ...
    many existing materials in machine learning had to be omitted. For a more
    complete coverage of machine learning, the following text books are
    recommended in addition to this lecture note:
    \begin{itemize}
...
\paragraph{Overfitting: Generalization Error}

\todo{}

\paragraph{How Wrong is Wrong?}

\todo{}

\subsection{Linear Separability and Nonlinear Classifiers}
...
\subsection{Decision Tree$^\star$}

\subsection{Ensemble Methods$^\star$}
...
\paragraph{Regularization and Prior Distributions}


\subsection{Gaussian Process Regression}


\paragraph{Bayesian Approach to Machine Learning}


\paragraph{Gaussian Process Regression$^\star$}
...
\paragraph{Maximum Variance Criterion}

\paragraph{Minimum Reconstruction Criterion}

\subsection{PCA with Missing Values$^\star$: Collaborative Filtering}

\paragraph{Probabilistic Principal Component Anlysis}
...
\subsection{Mixture of Gaussians$^\star$}

\subsection{Other Clustering Methods$^\star$}
