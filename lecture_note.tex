...
could be anything from a colour image, video clip to a friend network of a
...
What does this process called {\it feature extraction}? That is because the
function $\phi$ can be thought of as extracting $d$-many characteristics of the
original input $\mathcal{X}$. Let us consider an example of document
categorization. 
