...
\begin{align*}
    \| \vx - \hat{\vx} \|^2_2.
\end{align*}
Surprisingly (or obviously), the subspace spanned by the principals components
minimizes this reconstruction error.  Based on this,  PCA could be thought of as
an algorithm that discovers a subspace that minimizes the reconstruction error.
This view will later used to construct a nonlinear extension of PCA.
