...
as in Eq.~\eqref{eq:empirical_loss}, that is\footnote{
    It is a usual practice to omit the model complexity term when computing this
    validation cost. 
}
\begin{align*}
...
\subsection{Complexity vs. Overfitting}
...
loss and consequently minimize the 0--1 loss. 
...
according to how likely that vector is. 
